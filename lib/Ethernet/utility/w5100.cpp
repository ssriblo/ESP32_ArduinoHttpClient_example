...
int8_t W5100Class::_sck;
int8_t W5100Class::_miso;
int8_t W5100Class::_mosi;
...
void W5100Class::init_spi_pins(int8_t sck, int8_t miso, int8_t mosi, int8_t ss)
{
	_sck = sck;
	_miso = miso;
	_mosi = mosi;
...
uint8_t W5100Class::init(void)
{
	...
	SPI.begin(_sck, _miso, _mosi, ss_pin);

	Serial.println("sck miso mosi ss");
	Serial.println(_sck);
